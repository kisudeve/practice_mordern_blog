      ...
      <div className="bg-white rounded-lg shadow-sm p-6 md:p-8">
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-md shadow-sm bg-yellow-400 text-gray-900 hover:bg-yellow-500 transition-colors font-medium"
          >
            <svg
